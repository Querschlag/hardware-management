<?php
	...
	*  Deliverer entity
	*
	*  Deliverer entity to store deliverer data
	*
	* @category 
	* @package
	...
	*/	
	class DelivererEntity
	{
		 ...
		 */
		public $delivererCompanyName;
		
		/**
		 *  storage for the deliverer street
		 */
		public $delivererStreet;
