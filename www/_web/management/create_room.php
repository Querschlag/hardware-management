...
<div id="breadcrumb_nav">
	<ul>
		...
		?>
		<li>
			>> <a href="index.php<?php echo navParams(); ?>">Raum hinzuf&uuml;gen</a>
		</li>
	</ul>
</div>
<div id="module">
	...
	<form method="post">
		...
		// check posts
		if (isset($_POST['floor']) == FALSE && isset($_POST['number']) == FALSE && isset($_POST['name']) == FALSE && isset($_POST['note']) == FALSE && isset($_GET['roomId']) == TRUE) {
		...
		?>>Erdgeschoss</option>
		<option value="1" <?php
		if (isset($_POST['floor']) && $_POST['floor'] == 1)
			echo 'selected';
		?>>1 Stockwerk</option>
		<option value="2" <?php
		if (isset($_POST['floor']) && $_POST['floor'] == 2)
			echo 'selected';
		?>>2 Stockwerk</option>
		</select>&nbsp;<span class="require">*</span>

		<p>Raumnummer</p>
		<input name="number" type="text" <?php
		...
		?>/>&nbsp;<span class="require">*</span>
		<p>Notiz</p>
		<textarea name="note" rows=6 cols=30 <?php
		if (isset($_POST['note']))
